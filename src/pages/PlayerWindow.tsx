  ...
  if (!entry) {
    return (
      <div
        ...
        className="relative flex h-screen select-none flex-col overflow-hidden rounded-2xl bg-background/60 text-muted-foreground backdrop-blur-3xl backdrop-saturate-150"
      >
